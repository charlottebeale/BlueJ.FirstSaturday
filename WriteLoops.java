...
public class WriteLoops {
    ...
    public int helloZipCode() {
        ...
        for( int i = 5; i <= 105; i++) {
            if(i > 51) {
                System.out.println("helloZipCode");
            } else {
                w = w +1;
            }
    ...
    public void simpleLoops() {
        ...
        // The do while loop will execute prior to the condition 
        //being met while the while loop has to meet a condition prior 
        //to it's execution.
    }
